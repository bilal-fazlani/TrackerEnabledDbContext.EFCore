...
namespace TrackerEnabledDbContext.EFCore.Tests
{
    ...
    public class DisconnectedContextTests : PersistanceTests<TestTrackerContext>
    {
        ...
        public void Should_update_with_no_logs()
        {
            ...
            TrackedModelWithMultipleProperties entity = ObjectFactory.Create<TrackedModelWithMultipleProperties>(save: true);
        ...
        public void Should_be_able_to_delete()
        {
            ...
            TrackedModelWithMultipleProperties newModel = new TrackedModelWithMultipleProperties
            {
                Id = existingModel.Id
            };
